...
use ~/.config/nushell/init/starship_init.nu # prompt
source ~/.config/nushell/init/carapace_init.nu # komentorivin täydennys
source ~/.config/nushell/init/atuin_init.nu # history
